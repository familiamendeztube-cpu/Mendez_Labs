...
export const THEMES: Theme[] = [
  {
    id: 'terminal',
    name: 'Terminal',
    description: 'Carbon and champagne — the house look',
    colors: {
      '--bg-root': '#030605',
      '--bg-surface': '#0B0D0C',
      '--bg-elevated': '#181A18',
      '--bg-overlay': '#080A09',
      '--text-primary': '#F2EDE4',
      '--text-secondary': '#BDB9AF',
      '--text-muted': '#7C7A72',
      '--accent': '#D6B77A',
      '--accent-deep': '#B58A3A',
      '--status-red': '#D94550',
      '--status-amber': '#E0A532',
      '--border-base': 'rgba(232,226,214,0.12)',
      '--border-active': 'rgba(214,183,122,0.45)',
      '--focus-ring': '#D6B77A',
      '--chart-green': '#36D67E',
      '--chart-red': '#D94550',
      '--chart-grid': 'rgba(124,122,114,0.08)',
    },
  },
  {
    id: 'midnight',
