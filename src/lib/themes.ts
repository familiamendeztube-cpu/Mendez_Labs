...
export const THEMES: Theme[] = [
  {
    id: 'terminal',
    name: 'Terminal',
    description: 'The default dark terminal look',
    colors: {
      '--bg-root': '#030605',
      '--bg-surface': '#0C0F0D',
      '--bg-elevated': '#1A1D1B',
      '--bg-overlay': '#080A09',
      '--text-primary': '#F1F0EC',
      '--text-secondary': '#B8BBB8',
      '--text-muted': '#737A76',
      '--accent': '#36D67E',
      '--accent-deep': '#168A52',
      '--status-red': '#D94550',
      '--status-amber': '#E0A532',
      '--border-base': 'rgba(220,225,222,0.12)',
      '--border-active': 'rgba(54,214,126,0.42)',
      '--focus-ring': '#20C878',
      '--chart-green': '#36D67E',
      '--chart-red': '#D94550',
      '--chart-grid': 'rgba(115,122,118,0.08)',
    },
  },
  {
    id: 'midnight',
